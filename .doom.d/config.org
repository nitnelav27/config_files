...
* Email in Emacs
This is my email configuration in Emacs. For now, it will work for two accounts: GMU and gmail. I took most of it from [[https://gitlab.com/dwt1/dotfiles/-/tree/master][Distrotube's dot files.]]
#+begin_src emacs-lisp
#+end_src
